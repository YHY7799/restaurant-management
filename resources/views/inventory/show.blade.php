        ...
        <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            @if ($item->low_stock_alert_sent)
                <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4">
                    <p class="font-bold">Low Stock Alert Active</p>
                    <p>Current stock: {{ $item->stock_quantity }} {{ $item->storage_unit }}</p>
                    <p>Minimum required: {{ $item->min_stock }} {{ $item->storage_unit }}</p>
                </div>
            @endif
